...
{		
	...
	else
	{
		...
		$(".logged-in-black #container").css("background-image","url(../assets/global/images/bg_white.gif)");
		$("#container").css("background-image","url(../assets/global/images/bg_white.gif)");
	}
}
